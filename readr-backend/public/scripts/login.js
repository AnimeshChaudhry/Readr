(function (window) {
  ...
  registerFormHandler.addSubmitHandler(function (data) {
    ...
    if ($("#new-password").val() !== $("#confirm-password").val()){
      ...
      dpd.users.post({username: data.emailAddress, password: data.password,firstname: data.firstName,lastname: data.lastName, book1: data.book1, book2: data.book2, book3: data.book3, book4: data.book4, book5: data.book5}).then(function(newAccount) {
